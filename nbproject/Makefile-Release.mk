...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sms-routeur: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sms-routeur ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/AckResource.o: AckResource.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AckResource.o AckResource.cpp

${OBJECTDIR}/AswResource.o: AswResource.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AswResource.o AswResource.cpp
...
${OBJECTDIR}/PublicApiResource.o: PublicApiResource.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PublicApiResource.o PublicApiResource.cpp

${OBJECTDIR}/SavedSend.o: SavedSend.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SavedSend.o SavedSend.cpp

${OBJECTDIR}/SendResource.o: SendResource.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SendResource.o SendResource.cpp
...
${OBJECTDIR}/StateMessage.o: StateMessage.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StateMessage.o StateMessage.cpp
